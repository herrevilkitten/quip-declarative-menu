...
var _jsxFileName = '/Users/ekidder/Personal/quip/quip-menu/src/MainMenu.jsx';
...
var _jsxFileName = "/Users/ekidder/Personal/quip/quip-menu/src/root.jsx";

var _quip = __webpack_require__(337);
...
var _jsxFileName = '/Users/ekidder/Personal/quip/quip-menu/src/App.jsx';
...
var _MenuBar = __webpack_require__(340);
    ...
    _createClass(App, [{
        ...
        value: function render() {
            return React.createElement(
                ...
                React.createElement('input', { name: 'label', type: 'text', value: this.state.label, onChange: this.handleChange, __source: {
                        fileName: _jsxFileName,
                        lineNumber: 36
                    },
                    __self: this
                ...
                React.createElement(
                    ...
                    React.createElement(
                        ...
                        React.createElement(
                            _Menu2.default,
                            { highlighted: this.state.highlighted, label: this.state.label, __source: {
                                    fileName: _jsxFileName,
                                    lineNumber: 39
                                },
                                __self: this
                            },
                            React.createElement(_Menu2.default, { id: 'submenu', label: 'Submenu', __source: {
                                    fileName: _jsxFileName,
                                    lineNumber: 41
                                },
                                __self: this
                    ...
                    React.createElement(_Menu2.default, { highlighted: !this.state.highlighted, label: this.state.label + " 2", __source: {
                            fileName: _jsxFileName,
                            lineNumber: 44
                        },
                        __self: this
...
var _jsxFileName = '/Users/ekidder/Personal/quip/quip-menu/src/MenuBar.jsx';

var _createClass = function () { function defineProperties(target, props) { for (var i = 0; i < props.length; i++) { var descriptor = props[i]; descriptor.enumerable = descriptor.enumerable || false; descriptor.configurable = true; if ("value" in descriptor) descriptor.writable = true; Object.defineProperty(target, descriptor.key, descriptor); } } return function (Constructor, protoProps, staticProps) { if (protoProps) defineProperties(Constructor.prototype, protoProps); if (staticProps) defineProperties(Constructor, staticProps); return Constructor; }; }();

var _MenuUtils = __webpack_require__(341);
...
var assignedMenuId = 0;

function componentToMenu(component) {
  var _component$props = component.props,
      id = _component$props.id,
      label = _component$props.label,
      highlighted = _component$props.highlighted,
      disabled = _component$props.disabled,
      handler = _component$props.handler;
  ...
  if (children) {
    ...
    menu.submenus = children.filter(function (child) {
...
function processMainMenu(component) {
  ...
  if (children) {
    submenus = children.filter(function (child) {
      return child.type === _Menu2.default;
    }).map(function (child) {
      return componentToMenu(child);
    });
  } else {
    submenus = [];
  }
...
function processMenuStructure(parent, menu) {
  ...
  if (parent.submenus) {
    newEntry.subCommands = parent.submenus.map(function (menu) {
      return menu.id;
    });
...
function buildMenuFromStructure(menus) {
  ...
  if (menus.length) {
    toolbarCommandIds.push.apply(toolbarCommandIds, _toConsumableArray(menus.map(function (menu) {
      return menu.id;
    })));
  }
...
function updateMenu(menuBar) {
  ...
  var children = menuBar.props.children;
  if (!Array.isArray(children)) {
    children = [children];
  }
  ...
  var menu = buildMenuFromStructure(toolbarMenu);
